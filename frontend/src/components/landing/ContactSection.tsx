...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1'}/landing/contact`, {
        method: 'POST',
        headers: {
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all ${
                  isSubmitting
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@aiexamplatform.com" className="text-blue-600 hover:text-blue-700">
                      support@aiexamplatform.com
                    </a>
                  </div>
                </div>
