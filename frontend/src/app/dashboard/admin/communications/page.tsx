...
import { Mail, Send, Inbox, Paperclip, X, Search, Plus, Reply, Trash2, Archive } from 'lucide-react';
...
export default function AdminCommunicationsPage() {
  ...
  // Fetch messages on mount and tab change
  useEffect(() => {
    fetchMessages();
  }, [selectedTab]);
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage correspondence with teachers</p>
          </div>
