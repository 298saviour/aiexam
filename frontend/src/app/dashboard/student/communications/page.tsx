...
const initialMessages: Message[] = [
  {
    id: 1,
    from: 'Mr. Johnson (Teacher)',
    to: 'Student',
    subject: 'Assignment Feedback',
    body: 'Dear Student, Your recent assignment shows great improvement. Keep up the good work!',
    date: '2024-11-10',
    read: false,
    type: 'received',
  },
  {
    id: 2,
    from: 'Student',
    to: 'Mrs. Adebayo (Teacher)',
    subject: 'Question about Homework',
    body: 'Dear Mrs. Adebayo, I have a question about the homework assignment...',
    date: '2024-11-08',
    read: true,
    type: 'sent',
  },
  {
    id: 3,
    from: 'Dr. Nwosu (Teacher)',
    to: 'Student',
    subject: 'Exam Schedule',
    body: 'Hello, Please note the updated exam schedule for next week...',
    date: '2024-11-05',
    read: true,
    attachments: [{ name: 'exam_schedule.pdf', size: 156000 }],
    type: 'received',
  },
];
*/
...
/* Removed mock data - now fetching from API
const teachers = [
  { id: 1, name: 'Mr. Johnson', subject: 'Biology' },
  { id: 2, name: 'Mrs. Adebayo', subject: 'Mathematics' },
  { id: 3, name: 'Dr. Nwosu', subject: 'Chemistry' },
  { id: 4, name: 'Prof. Ibrahim', subject: 'Physics' },
  { id: 5, name: 'Mrs. Eze', subject: 'English' },
];
*/
  ...
  return (
    <DashboardLayout sidebar={<StudentSidebar />}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage correspondence with your teachers</p>
          </div>
      ...
      <Modal
        ...
        title="Compose Message to Teacher"
      >
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              {teachers.map((teacher) => (
                <option key={teacher.id} value={`${teacher.name} (Teacher)`}>
